...
@section('title')
@lang('site.edit')  @lang('site.CUSTOMERS')
@endsection
@section('content')
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <h1>@lang('site.edit')  @lang('site.CUSTOMERS')</h1>
            ...
            <ol class="breadcrumb">
                ...
                <li class="active">@lang('site.edit')  @lang('site.CUSTOMERS')</li>
            </ol>
        </section>
...
{{-- name  --}}
 ...
 {{--  phone  --}}
                        <div class="form-group">
                            ...
                            <input type="tel" name="phone[]" id="phone" class="form-control" value="{{ $customer->phone[$i]??'' }}">
